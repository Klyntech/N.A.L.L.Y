...
class SubAgent:
    ...
    def _run(self):
        ...
        self.messages = [
            {"role": "system", "content": f"""You are a focused sub-agent. Your sole goal is:
{self.goal}
